        ...
        <div className="flex h-screen w-full overflow-hidden font-manrope bg-[#FAFAF9]">
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div className="mb-10">
                        ...
                        <p className="mt-2 text-sm text-stone-600">
                            Уже есть аккаунт?{" "}
                            <Link href="/ru/auth/login" className="font-medium text-orange-600 hover:text-orange-500">
                                Войти
                            </Link>
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="name" className="text-stone-900 font-bold">Имя</Label>
                            <Input
                                id="name"
                                type="text"
            ...
            <div className="hidden relative lg:flex lg:w-1/2 h-full bg-stone-900 items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 px-12 text-center text-white max-w-lg">
                    <h2 className="text-4xl font-extrabold mb-6 tracking-tight">Присоединяйтесь к сообществу</h2>
                    <p className="text-lg text-stone-300 leading-relaxed">
                        Начните читать, делиться и обмениваться книгами уже сегодня. Более 1000 книг ждут вас.
                    </p>
                </div>
            </div>
        </div>
