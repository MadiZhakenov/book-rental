                ...
                <section className="relative overflow-hidden flex-1 flex flex-col justify-center py-12 lg:py-0">
                    ...
                    <div className="container relative z-10 mx-auto px-4 text-center">
                        ...
                        <h1 className="mx-auto max-w-5xl text-4xl font-extrabold tracking-tight text-stone-900 sm:text-5xl lg:text-7xl mb-6 leading-tight">
                            Арендуйте книги у <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600">соседей</span>
                        </h1>

                        <p className="mx-auto max-w-2xl text-lg text-stone-600 leading-relaxed mb-8">
                            Экономьте деньги, освобождайте полки и находите единомышленников. Присоединяйтесь к сообществу из более чем 10,000 читателей.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            <div className="flex flex-col items-center sm:items-start text-sm">
                                ...
                                <p className="text-stone-600 font-medium text-xs">Более <span className="text-stone-900 font-bold">1,000+</span> читателей</p>
                            </div>
                        </div>
                    </div>
                </section>
