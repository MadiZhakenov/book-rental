...
export default function LoginPage() {
    ...
    const onSubmit = async (data: LoginForm) => {
        try {
            ...
            setError(err.response?.data?.message || "Қате деректер");
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <div className="flex h-screen w-full overflow-hidden font-manrope bg-[#FAFAF9]">
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div className="mb-10">
                        ...
                        <p className="mt-2 text-sm text-stone-600">
                            Аккаунтыңыз жоқ па?{" "}
                            <Link href="/kk/auth/register" className="font-medium text-orange-600 hover:text-orange-500">
                                Тіркелу
                            </Link>
                        </p>
                    </div>
            ...
            <div className="hidden relative lg:flex lg:w-1/2 h-full bg-stone-900 items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 px-12 text-center text-white max-w-lg">
                    <h2 className="text-4xl font-extrabold mb-6 tracking-tight">Book Rental-ға қош келдіңіз</h2>
                    <p className="text-lg text-stone-300 leading-relaxed">
                        Білім алмасуға арналған бірыңғай платформа. Көршілеріңізден кітаптарды жалға алыңыз және сүйікті оқиғаларыңызбен бөлісіңіз.
                    </p>
                </div>
            </div>
        </div>
